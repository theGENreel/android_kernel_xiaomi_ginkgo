...
# Kernel base version
KERNEL_BASE_VERSION = 4.14.309

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = console=ttyMSM0,115200n8 androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=1 firmware_class.path=/vendor/firmware_mnt/image earlycon=msm_geni_serial,0x4a90000 loop.max_part=7 cgroup.memory=nokmem,nosocket buildvariant=user console=tty0 droidian.lvm.prefer
...
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/trinket.dtb
...
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/qcom/ginkgo-trinket-overlay.dtbo
...
BUILD_PATH = /usr/lib/clang908/bin
